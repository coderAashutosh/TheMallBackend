...
export const signup = asyncError(async (req, res, next) => {
    ...
    const { name, email, password, address, city, state, country, pinCode } = req.body;
...
export const logOut = asyncError(async (req, res, next) => {
    ...
    res.status(200).cookie("token", "", {
        ...
        success: true,
        message: "Logged Out Successfully. Hope to see you soon :)"
    });
});
...
export const updateProfile = asyncError(async (req, res, next) => {
    ...
    const { name, email, address, city, state, country, pinCode } = req.body;
...
export const changePassword = asyncError(async (req, res, next) => {
    ...
    if (!oldPassword || !newPassword)
        return next(
            new ErrorHandler("Please Enter Your Previous Password & New Password", 400)
        );
